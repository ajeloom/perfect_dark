...
#define WEAPONPROG_VANILLA_ALLGUNS 1
#define WEAPONPROG_ALLGUNS	2
#define WEAPONPROG_ONEGUN	3
#define WEAPONPROG_TYPES	4

#define CHARACTER_CASSANDRA 0
#define CHARACTER_DRCAROLL 1
#define CHARACTER_JONATHAN 2
#define CHARACTER_ELVIS 3
#define CHARACTER_PRESIDENT 4
