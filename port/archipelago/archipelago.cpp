...
std::map<int, std::string> locationNames = {
    ...
    {18895, "A51 Escape (Agent/Special): Pick up Shield after unlocking the medical containment doors"},
    ...
    {26052, "Pelagic II: Pick up double Falcon 2 (scope) dropped by the guard past the fourth door from the start of the mission without setting off the alarm"},
