...
std::map<int, std::string> locationNames = {
    ...
    {490, "Cheat Unlock: Get gold on Falcon 2, Falcon 2 (Silencer), and Falcon 2 (Scope)"},
    {491, "Cheat Unlock: Get gold on MagSec 4, Mauler, Phoenix, DY357 Magnum, and DY357-LX"},
    {492, "Cheat Unlock: Get gold on CMP150, Cyclone, Callisto NTG, and RC-P120"},
    {493, "Cheat Unlock: Get gold on Laptop Gun, Dragon, K7 Avenger, AR34, and SuperDragon"},
    {494, "Cheat Unlock: Get gold on Shotgun, Sniper Rifle, Rocket Launcher, and Slayer"},
    {495, "Cheat Unlock: Get gold on Timed Mine, Proximity Mine, and Remote Mine"},
    {496, "Cheat Unlock: Get gold on FarSight XR-20, Crossbow, Combat Knife, and Grenade"},
    {497, "Cheat Unlock: Get gold on Tranquilizer, Reaper, and Devastator"},
    ...
    {2010, "dD Defection: 3F Shield - (Agent/Special)"},
    {2033, "dD Defection: 2F double Falcon 2 (silencer)"},
    {2466, "dD Defection: 2F Laptop Gun"},
    {2468, "dD Defection: 2F Falcon 2 (silencer) (right side)"},
    {2469, "dD Defection: 2F Falcon 2 (silencer) (left side)"},
    {2470, "dD Defection: 3F tiny ammo box (on corner desk)"},
    {2471, "dD Defection: 3F tiny ammo box (on table near couch)"},
    {2472, "dD Defection: 2F tiny ammo box (on desk across the stairs)"},
    {2473, "dD Defection: 2F tiny ammo box (on desk across the elevator)"},
    {2474, "dD Defection: 2F Falcon 2 (silencer) (on desk)"},
    {2475, "dD Defection: 2F tiny ammo box (under stairs)"},
    {2605, "dD Defection: 1F CMP150 (on right of front desk)"},
    {2606, "dD Defection: 1F CMP150 (on left of front desk)"},
    {2607, "dD Defection: 1F Shield - (Agent)"},
    {4625, "dD Investigation: ammo box (front of room above the K7 Avenger)"},
    {4626, "dD Investigation: ammo box (back of room above the K7 Avenger)"},
    {4627, "dD Investigation: ammo box (front of room with one scientist)"},
    {4628, "dD Investigation: ammo box (back of room with one scientist)"},
    {4629, "dD Investigation: ammo box (front of Night Vision room)"},
    {4630, "dD Investigation: ammo box (back of Night Vision room)"},
    {4631, "dD Investigation: ammo box (front of room near two scientists)"},
    {4632, "dD Investigation: ammo box (back of room near two scientists)"},
    {4633, "dD Investigation: CMP150 (on front of table)"},
    {4634, "dD Investigation: CMP150 (on back of table)"},
    {4635, "dD Investigation: CMP150 (left of secret weapons compartment)"},
    {4636, "dD Investigation: CMP150 (right of secret weapons compartment)"},
    {4637, "dD Investigation: Proximity Mine (in radioactive room)"},
    {4638, "dD Investigation: Shield (on crate) - (Agent)"},
    {4639, "dD Investigation: Shield (behind the glass) - (Agent/Special)"},
    {6005, "dD Extraction: 1F DY357 Magnum (from fifth guard)"},
    {6120, "dD Extraction: 2F Shield - (Agent)"},
    {6452, "dD Extraction: 4F Rocket Launcher"},
    {6466, "dD Extraction: 4F Grenade (on Cassandra's desk)"},
    {6467, "dD Extraction: 4F Dragon (in hidden room in Cassandra's office)"},
    {6516, "dD Extraction: Roof ammo box (on left)"},
    {6519, "dD Extraction: Roof ammo box (on right)"},
    {8000, "Carrington Villa: Devastator (in helipad crate)"},
    {8001, "Carrington Villa: 1st ammo box (in crate on observatory path)"},
    {8002, "Carrington Villa: 2nd ammo box (in crate on observatory path)"},
    {8003, "Carrington Villa: 3rd ammo box (in crate on observatory path)"},
    {8004, "Carrington Villa: 4th ammo box (in crate on observatory path)"},
    {8005, "Carrington Villa: 5th ammo box (in crate on observatory path)"},
    {8006, "Carrington Villa: 6th ammo box (in crate on observatory path)"},
    {8007, "Carrington Villa: 7th ammo box (in crate on observatory path)"},
    {8008, "Carrington Villa: 8th ammo box (in crate on observatory path)"},
    {8009, "Carrington Villa: 9th ammo box (in crate on observatory path)"},
    {8085, "Carrington Villa: Sniper Rifle (in the bathroom) - (Perfect Agent)"},
    {8410, "Carrington Villa: double CMP150 (from sniper near the helipad)"},
    {8568, "Carrington Villa: Shield (on helipad crate) - (Agent)"},
    {8569, "Carrington Villa: Shield (in the bathroom) - (Agent)"},
    {10000, "Chicago: BombSpy (in the dumpster)"},
    {10287, "Chicago: double Falcon 2 (scope) (in the Pond Punk)"},
    {10289, "Chicago: Shield (near the taxi) - (Agent)"},
    {10290, "Chicago: Shield (under stairs near Pond Punk) - (Agent/Special)"},
    {12000, "G5 Building: Crossbow (after knocking out first two guards)"},
    {12086, "G5 Building: Shield (on stairs to the upper exit) - (Agent/Special)"},
    {12149, "G5 Building: N-Bomb (near the upper exit)"},
    {12150, "G5 Building: Shield (in room before the laser grids) - (Agent)"},
    {14052, "A51 Infiltration: Rocket Launcher (in mine field)"},
    {14053, "A51 Infiltration: double MagSec 4 (after placing comms rider)"},
    {14150, "A51 Infiltration: Shield (near hoverbike) - (Agent)"},
    {15381, "A51 Infiltration: Shield (in the crawl space) - (Agent/Special)"},
    {16004, "A51 Rescue: Shield (guard past first elevator) - (Agent)"},
    {16905, "A51 Rescue: Phoenix (past locked hangar door)"},
    {16987, "A51 Rescue: double Falcon 2 (silencer) (hidden in barrel)"},
    {17140, "A51 Rescue: Shield (on desk near computer) - (Agent/Special)"},
    {18036, "A51 Escape: double Falcon 2 (scope) (behind you at the start)"},
    {18040, "A51 Escape: Shield (dropped by biotechnician) - (Agent)"},
    {18895, "A51 Escape: Shield (behind locked medical containment doors) - (Agent/Special)"},
    {19383, "A51 Escape: Remote Mine (in first room with guards)"},
    {20017, "Air Base: Shield (dropped by NSA Lackey) - (Agent)"},
    {20018, "Air Base: double DY357 Magnum (after knocking out all NSA Lackeys)"},
    {20181, "Air Base: Proximity Mine (past the cave)"},
    {20214, "Air Base: Shield (in the safe) - (Agent/Special)"},
    {22203, "Air Force One: Cyclone (in room right of stairs)"},
    {22204, "Air Force One: Cyclone (in room left of stairs)"},
    {22363, "Air Force One: Shield (in piano room) - (Agent/Special)"},
    {22364, "Air Force One: Shield (in small kitchen) - (Agent)"},
    {24001, "Crash Site: DY357-LX (from disarming Trent)"},
    {24144, "Crash Site: Shield (behind President's clone) - (Agent/Special)"},
    {24262, "Crash Site: Shield (near the crashed UFO) - (Agent)"},
    {24263, "Crash Site: Proximity Mine (from Elvis before doing any objective)"},
    {26052, "Pelagic II: double Falcon 2 (silencer) (from guard and no alarm)"},
    {26541, "Pelagic II: Shield (on the helipad) - (Agent)"},
    {26542, "Pelagic II: Shield (on the sub hangar crate) - (Agent/Special)"},
    {28008, "Deep Sea: Proximity Mine (from guard in 2nd room with cloaked guards)"},
    {28018, "Deep Sea: Shield (on the left path) - (Agent/Special)"},
    {28026, "Deep Sea: Shield (dropped from guard) - (Agent)"},
    {28063, "Deep Sea: Shotgun (near Shield on the left path)"},
    {30000, "CI Defense: Devastator (dropped after saving most of the hostages)"},
    {30146, "CI Defense: Basement Shield - (Agent/Special)"},
    {30648, "CI Defense: 2F Shield - (Agent)"},
    {32045, "Attack Ship: double Mauler (dropped from Skedar in final room)"},
    {32051, "Attack Ship: De Vries' necklace - (Perfect Agent)"},
    {32466, "Attack Ship: Slayer (in the room past green chambers)"},
    {32499, "Attack Ship: Shield (on table) - (Agent/Special)"},
    {34050, "Skedar Ruins: double Phoenix (near the gap)"},
    {34186, "Skedar Ruins: Shield (area past the gap to the right) - (Agent/Special)"},
    {34337, "Skedar Ruins: Shield (behind the fallen pillar) - (Agent)"},
    {36010, "Mr. Blonde's Revenge: 3F Shield - (Agent/Special)"},
    {36015, "Mr. Blonde's Revenge: 1F double CMP150 (from guard near bottom elevator)"},
    {36466, "Mr. Blonde's Revenge: 2F Laptop Gun"},
    {36468, "Mr. Blonde's Revenge: 2F Falcon 2 (right side)"},
    {36469, "Mr. Blonde's Revenge: 2F Falcon 2 (left side)"},
    {36470, "Mr. Blonde's Revenge: 3F tiny ammo box (on corner desk)"},
    {36471, "Mr. Blonde's Revenge: 3F tiny ammo box (on table near couch)"},
    {36472, "Mr. Blonde's Revenge: 2F tiny ammo box (on desk across the stairs)"},
    {36473, "Mr. Blonde's Revenge: 2F tiny ammo box (on desk across the elevator)"},
    {36474, "Mr. Blonde's Revenge: 2F Falcon 2 (on desk)"},
    {36475, "Mr. Blonde's Revenge: 2F tiny ammo box (under stairs)"},
    {36605, "Mr. Blonde's Revenge: 1F CMP150 (on right of front desk)"},
    {36606, "Mr. Blonde's Revenge: 1F CMP150 (on left of front desk)"},
    {36607, "Mr. Blonde's Revenge: 1F Shield - (Agent)"},
    {38011, "Maian SOS: double DY357-LX (from dual-wielding guard)"},
    {38919, "Maian SOS: Psychosis Gun (on desk near the start)"},
};
