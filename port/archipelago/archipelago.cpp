...
std::map<int, std::string> locationNames = {
    ...
    {579, "Complete G5 Building (Agent): Bottom Exit"},
    {580, "Complete G5 Building (Agent): Upper Exit"},
    {581, "Complete G5 Building (Special Agent): Bottom Exit"},
    {582, "Complete G5 Building (Special Agent): Upper Exit"},
    {583, "Complete G5 Building (Perfect Agent): Bottom Exit"},
    {584, "Complete G5 Building (Perfect Agent): Upper Exit"},
    {585, "Complete A51 Escape (Agent): UFO Escape"},
    {586, "Complete A51 Escape (Agent): Alternate Escape"},
    {587, "Complete A51 Escape (Special Agent): UFO Escape"},
    {588, "Complete A51 Escape (Special Agent): Alternate Escape"},
    {589, "Complete A51 Escape (Perfect Agent): UFO Escape"},
    {590, "Complete A51 Escape (Perfect Agent): Alternate Escape"},
    {591, "Complete Air Base (Agent): Shuttle Exit"},
    {592, "Complete Air Base (Agent): Ladder Exit"},
    {593, "Complete Air Base (Special Agent): Shuttle Exit"},
    {594, "Complete Air Base (Special Agent): Ladder Exit"},
    {595, "Complete Air Base (Perfect Agent): Shuttle Exit"},
    {596, "Complete Air Base (Perfect Agent): Ladder Exit"},
    {2010, "dD Defection (Agent/Special): Pick up Shield from the guard on the floor below Cassandra's office"},
    {2033, "dD Defection: Pick up double Falcon 2 (silencer) from guard in the room next to the office worker's office"},
    {2466, "dD Defection: Pick up Laptop Gun in the room that the office worker hides in"},
    {2468, "dD Defection: Pick up Falcon 2 (silencer) on the right side of the room that the office worker hides in"},
    {2469, "dD Defection: Pick up Falcon 2 (silencer) on the left side of the room that the office worker hides in"},
    {2470, "dD Defection: Pick up tiny ammo box on the desk in the corner room with 4 windows (floor below Cassandra's office)"},
    {2471, "dD Defection: Pick up tiny ammo box on the desk in the room next to the computer room (floor below Cassandra's office)"},
    {2472, "dD Defection: Pick up tiny ammo box on the desk in the room next to the room the office worker hides in (2nd floor below Cassandra's office)"},
    {2473, "dD Defection: Pick up tiny ammo box on the desk in room across the elevator (2nd floor below Cassandra's office)"},
    {2474, "dD Defection: Pick up Falcon 2 (silencer) on the desk in the corner room (2nd floor below Cassandra's office)"},
    {2475, "dD Defection: Pick up tiny ammo box under the stairs that leads to the 2nd floor below Cassandra's office"},
    {2605, "dD Defection: Pick up right CMP150 behind the front desk"},
    {2606, "dD Defection: Pick up left CMP150 behind the front desk"},
    {2607, "dD Defection (Agent): Pick up Shield next to the elevator on the bottom floor"},
    {4625, "dD Investigation: Pick up left ammo box in the room above the K7 Avenger guard"},
    {4626, "dD Investigation: Pick up right ammo box in the room above the K7 Avenger guard"},
    {4627, "dD Investigation (Special/Perfect): Pick up left ammo box in the room with one scientist"},
    {4628, "dD Investigation (Special/Perfect): Pick up right ammo box in the room with one scientist"},
    {4629, "dD Investigation: Pick up left ammo box in the room with the Night Vision"},
    {4630, "dD Investigation: Pick up right ammo box in the room with the Night Vision"},
    {4631, "dD Investigation (Special/Perfect): Pick up left ammo box in the first room near the two scientists"},
    {4632, "dD Investigation (Special/Perfect): Pick up right ammo box in the first room near the two scientists"},
    {4633, "dD Investigation: Pick up first CMP150 on the table in the room past the laser grids"},
    {4634, "dD Investigation: Pick up second CMP150 on the table in the room past the laser grids"},
    {4635, "dD Investigation: Pick up left CMP150 in the secret weapons compartment"},
    {4636, "dD Investigation: Pick up right CMP150 in the secret weapons compartment"},
    {4637, "dD Investigation: Pick up Proximity Mine behind the radioactive isotope"},
    {4638, "dD Investigation (Agent): Pick up Shield on the crate in the room with the maintenance hatch"},
    {4639, "dD Investigation (Agent/Special): Pick up Shield inside the glass enclosure in the room past the laser grids"},
    {6005, "dD Extraction: Pick up DY357 Magnum from the fifth guard after eliminating the first five guards without being seen"},
    {6120, "dD Extraction (Agent): Pick up Shield inside the room to the left of the elevator (2nd floor under Cassandra's office)"},
    {6452, "dD Extraction: Pick up the Rocket Launcher in the room outside Cassandra's office"},
    {6466, "dD Extraction: Pick up Grenade on Cassandra's desk"},
    {6467, "dD Extraction: Pick up Dragon in the hidden room near Cassandra's office"},
    {6516, "dD Extraction: Pick up first rocket ammo box on the roof"},
    {6519, "dD Extraction: Pick up second rocket ammo box on the roof"},
    {8000, "Carrington Villa: Pick up Devastator hidden in crate near the helipad"},
    {8001, "Carrington Villa: Pick up first ammo box hidden in crate leading to the observatory"},
    {8002, "Carrington Villa: Pick up second ammo box hidden in crate leading to the observatory"},
    {8003, "Carrington Villa: Pick up third ammo box hidden in crate leading to the observatory"},
    {8004, "Carrington Villa: Pick up fourth ammo box hidden in crate leading to the observatory"},
    {8005, "Carrington Villa: Pick up fifth ammo box hidden in crate leading to the observatory"},
    {8006, "Carrington Villa: Pick up sixth ammo box hidden in crate leading to the observatory"},
    {8007, "Carrington Villa: Pick up seventh ammo box hidden in crate leading to the observatory"},
    {8008, "Carrington Villa: Pick up eighth ammo box hidden in crate leading to the observatory"},
    {8009, "Carrington Villa: Pick up ninth ammo box hidden in crate leading to the observatory"},
    {8085, "Carrington Villa (Perfect Agent): Pick up Sniper Rifle in the bathroom"},
    {8410, "Carrington Villa: Pick up double CMP150 dropped from the sniper near the helipad in under 38 seconds"},
    {8568, "Carrington Villa (Agent): Pick up Shield on the crate near the helipad"},
    {8569, "Carrington Villa (Agent): Pick up Shield inside the bathroom"},
    {10000, "Chicago: Pick up BombSpy hidden in the dumpster"},
    {10287, "Chicago: Pick up double Falcon 2 (scope) inside the Pond Punk"},
    {10289, "Chicago (Agent): Pick up Shield in the grate under the taxi"},
    {10290, "Chicago (Agent/Special): Pick up Shield under the stairs that leads to the Pond Punk"},
    {12000, "G5 Building: Pick up Crossbow after knocking out the first two guards"},
    {12086, "G5 Building (Agent/Special): Pick up Shield on the stairs leading to the upper exit"},
    {12149, "G5 Building (Special/Perfect): Pick up N-Bomb near the upper exit after placing Remote Mine on the upper exit in Chicago"},
    {12150, "G5 Building (Agent): Pick up Shield in the room before the one with the lasers"},
    {14052, "A51 Infiltration: Pick up Rocket Launcher in the mine field"},
    {14053, "A51 Infiltration (Special/Perfect): Pick up double MagSec 4 from A51 guard after placing comms rider"},
    {14150, "A51 Infiltration (Agent): Pick up Shield under the gun turret near the hoverbike"},
    {15381, "A51 Infiltration (Agent/Special): Pick up Shield in the crawl space that leads to the mine field"},
    {16004, "A51 Rescue (Agent): Pick up Shield from the guard past the bottom of the first elevator"},
    {16905, "A51 Rescue: Pick up Phoenix after knocking out technician in A51 Infiltration then getting them to open the door to the right of the first elevator"},
    {16987, "A51 Rescue: Pick up Falcon 2 (silencer) hidden in barrel under the stack of the crates"},
    {17140, "A51 Rescue (Agent/Special): Pick up Shield on the desk in the room next to the locked room at the top of the sloping corridor"},
    {18036, "A51 Escape: Pick up double Falcon 2 (scope) in the room behind you at the start of the mission"},
    {18040, "A51 Escape (Agent): Pick up Shield dropped by the biotechnician in the circular room without the slope after moving Elvis to safety"},
    {18895, "A51 Escape (Agent/Special): Pick up Shield behind the locked medical containment doors"},
    {19383, "A51 Escape: Pick up Remote Mine in the room before the secret hangar after moving Elvis to safety within 36 seconds"},
    {20017, "Air Base (Agent): Pick up Shield dropped by NSA Lackey near the elevator door"},
    {20018, "Air Base: Pick up double DY357 Magnum after knocking out the three NSA Lackeys"},
    {20181, "Air Base: Pick up Proximity Mine past the cave"},
    {20214, "Air Base (Agent/Special): Pick up Shield in the safe with the flight plans"},
    {22203, "Air Force One: Pick up Cyclone in the small room to the right of the stairs"},
    {22204, "Air Force One: Pick up Cyclone in the small room to the left of the stairs"},
    {22363, "Air Force One (Agent/Special): Pick up Shield in the room with the piano"},
    {22364, "Air Force One (Agent): Pick up Shield in the small kitchen past the stairs that leads to the lower deck"},
    {24001, "Crash Site: Pick up DY357-LX by disarming Trent"},
    {24144, "Crash Site (Agent/Special): Pick up Shield behind the President's clone"},
    {24262, "Crash Site (Agent): Pick up Shield near the crashed UFO"},
    {24263, "Crash Site: Get Proximity Mine from Elvis before completing any objective"},
    {26052, "Pelagic II: Pick up double Falcon 2 (silencer) dropped by the guard past the fourth door from the start of the mission without setting off the alarm"},
    {26541, "Pelagic II (Agent): Pick up Shield on the helipad"},
    {26542, "Pelagic II (Agent/Special): Pick up Shield on the crate in the Moon Pool room"},
    {28008, "Deep Sea: Pick up Proximity Mine dropped by guard on the far left from the dead Skedar before Elvis gets them"},
    {28018, "Deep Sea (Agent/Special): Pick up Shield on the left path from the first teleportal"},
    {28026, "Deep Sea (Agent): Pick up Shield dropped from Sniper guard"},
    {28063, "Deep Sea: Pick up Shotgun next to the Shield on the left path from the first teleportal"},
    {30000, "CI Defense: Pick up Devastator in the Info Room after saving most of the hostages"},
    {30146, "CI Defense (Agent/Special): Pick up Shield in the basement room with the two small hangar doors"},
    {30648, "CI Defense (Agent): Pick up Shield on the second floor at the dead end opposite from Carrington's office"},
    {32045, "Attack Ship: Pick up double Mauler in the final room from the Skedar on top of the bridge"},
    {32051, "Attack Ship (Perfect Agent): Pick up De Vries' necklace"},
    {32466, "Attack Ship: Pick up Slayer in the room straight ahead from the lift you take with Elvis"},
    {32499, "Attack Ship (Agent/Special): Pick up Shield on table in the room to the right after taking the lift with Elvis"},
    {34050, "Skedar Ruins: Pick up double Phoenix near the gap after blowing up the two pillars that didn't need the target amplifier"},
    {34186, "Skedar Ruins (Agent/Special): Pick up Shield in the area past the gap to the right near the cheese"},
    {34337, "Skedar Ruins (Agent): Pick up Shield behind the fallen pillar"},
    {36010, "Mr. Blonde's Revenge (Agent/Special): Pick up Shield from the guard on the floor below Cassandra's office"},
    {36015, "Mr. Blonde's Revenge: Pick up double CMP150 from guard near the elevator where you plant the bomb"},
    {36466, "Mr. Blonde's Revenge: Pick up Laptop Gun in the room that the office worker hides in"},
    {36468, "Mr. Blonde's Revenge: Pick up Falcon 2 on the right side of the room that the office worker hides in"},
    {36469, "Mr. Blonde's Revenge: Pick up Falcon 2 on the left side of the room that the office worker hides in"},
    {36470, "Mr. Blonde's Revenge: Pick up tiny ammo box on the desk in the corner room with 4 windows (floor below Cassandra's office)"},
    {36471, "Mr. Blonde's Revenge: Pick up tiny ammo box on the desk in the room next to the computer room (floor below Cassandra's office)"},
    {36472, "Mr. Blonde's Revenge: Pick up tiny ammo box on the desk in the room next to the room the office worker hides in (2nd floor below Cassandra's office)"},
    {36473, "Mr. Blonde's Revenge: Pick up tiny ammo box on the desk in room across the elevator (2nd floor below Cassandra's office)"},
    {36474, "Mr. Blonde's Revenge: Pick up Falcon 2 on the desk in the corner room (2nd floor below Cassandra's office)"},
    {36475, "Mr. Blonde's Revenge: Pick up tiny ammo box under the stairs that leads to the 2nd floor below Cassandra's office"},
    {36605, "Mr. Blonde's Revenge: Pick up right CMP150 behind the front desk"},
    {36606, "Mr. Blonde's Revenge: Pick up left CMP150 behind the front desk"},
    {36607, "Mr. Blonde's Revenge (Agent): Pick up Shield next to the glass elevator on the bottom floor"},
    {38011, "Maian SOS: Pick up double DY357-LX from guard in the circular room with the exit"},
...
bool Initialize() {
	...
	ap->set_slot_connected_handler([](const json& data) {
        ...
        if (data.contains("options")) {
            ...
            if (data.at("options").contains("pickupsanity")) {
                hasPickupsanity = data.at("options").at("pickupsanity");
            }
