...
std::map<int, std::string> locationNames = {
    ...
    {6005, "dD Extraction: Pick up DY357 Magnum from the fifth guard after defeating the first five guards without being seen"},
    ...
    {12150, "G5 Building (Agent): Pick up Shield in the room before the room with the lasers"},
    ...
    {18036, "A51 Escape: Pick up double Falcon 2 (scope) in the room where the two biotechnicians are in"},
